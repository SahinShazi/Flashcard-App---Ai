...
const CreateSet = () => {
  ...
  const validateForm = () => {
    ...
    if (cards.some(card => !card.question.trim() || !card.answer.trim())) {
      newErrors.cards = 'All cards must have both question and answer';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const setData = {
        ...formData,
        cards: cards.filter(card => card.question.trim() && card.answer.trim())
      };
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Create New Flashcard Set</h1>
        <p className="text-gray-600 mt-2">Build your custom flashcard set with questions and answers</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="card p-6">
          ...
          {errors.cards && (
            <p className="text-sm text-red-600 mb-4">{errors.cards}</p>
          )}
